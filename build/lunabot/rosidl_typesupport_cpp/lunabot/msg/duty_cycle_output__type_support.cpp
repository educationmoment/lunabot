...
static const _DutyCycleOutput_type_support_symbol_names_t _DutyCycleOutput_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lunabot, msg, DutyCycleOutput)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lunabot, msg, DutyCycleOutput)),
  }
};
...
{
  return &::lunabot::msg::rosidl_typesupport_cpp::DutyCycleOutput_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lunabot, msg, DutyCycleOutput)() {
  return get_message_type_support_handle<lunabot::msg::DutyCycleOutput>();
}
