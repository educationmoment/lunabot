...
#include "lunabot/msg/detail/duty_cycle_output__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lunabot::msg::DutyCycleOutput & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lunabot::msg::DutyCycleOutput & ros_message)
{
  // Member: left_drive_output
  cdr >> ros_message.left_drive_output;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lunabot::msg::DutyCycleOutput;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lunabot::msg::DutyCycleOutput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lunabot::msg::DutyCycleOutput *>(
    untyped_ros_message);
...
{
  return &lunabot::msg::typesupport_fastrtps_cpp::_DutyCycleOutput__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lunabot, msg, DutyCycleOutput)() {
  return &lunabot::msg::typesupport_fastrtps_cpp::_DutyCycleOutput__handle;
}
