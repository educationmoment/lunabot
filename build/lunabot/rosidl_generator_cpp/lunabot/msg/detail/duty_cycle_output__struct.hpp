...
#ifndef LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__STRUCT_HPP_
#define LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lunabot__msg__DutyCycleOutput __attribute__((deprecated))
#else
# define DEPRECATED__lunabot__msg__DutyCycleOutput __declspec(deprecated)
#endif
...
struct DutyCycleOutput_
{
  ...
  // pointer types
  using RawPtr =
    lunabot::msg::DutyCycleOutput_<ContainerAllocator> *;
  using ConstRawPtr =
    const lunabot::msg::DutyCycleOutput_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lunabot::msg::DutyCycleOutput_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lunabot__msg__DutyCycleOutput
    std::shared_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lunabot__msg__DutyCycleOutput
    std::shared_ptr<lunabot::msg::DutyCycleOutput_<ContainerAllocator> const>
...
using DutyCycleOutput =
  lunabot::msg::DutyCycleOutput_<std::allocator<void>>;
...
#endif  // LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__STRUCT_HPP_
