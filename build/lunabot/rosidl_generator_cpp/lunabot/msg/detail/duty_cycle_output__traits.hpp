...
#ifndef LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__TRAITS_HPP_
#define LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__TRAITS_HPP_
...
inline void to_yaml(
  const lunabot::msg::DutyCycleOutput & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lunabot::msg::DutyCycleOutput & msg)
{
  return lunabot::msg::to_yaml(msg);
}

template<>
inline const char * data_type<lunabot::msg::DutyCycleOutput>()
{
  return "lunabot::msg::DutyCycleOutput";
}

template<>
inline const char * name<lunabot::msg::DutyCycleOutput>()
{
  return "lunabot/msg/DutyCycleOutput";
}

template<>
struct has_fixed_size<lunabot::msg::DutyCycleOutput>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<lunabot::msg::DutyCycleOutput>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<lunabot::msg::DutyCycleOutput>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // LUNABOT__MSG__DETAIL__DUTY_CYCLE_OUTPUT__TRAITS_HPP_
