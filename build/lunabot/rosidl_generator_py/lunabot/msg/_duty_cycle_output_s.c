...
bool lunabot__msg__duty_cycle_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lunabot.msg._duty_cycle_output.DutyCycleOutput", full_classname_dest, 46) == 0);
  }
  lunabot__msg__DutyCycleOutput * ros_message = _ros_message;
  {  // left_drive_output
...
PyObject * lunabot__msg__duty_cycle_output__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lunabot.msg._duty_cycle_output");
